...
"[project]/components/animation/DoorTransition.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useRoomStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/useRoomStore.ts [app-client] (ecmascript)");
;
...
function DoorTransition({ children }) {
    _s();
    const { doorTransitionState } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useRoomStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoomStore"])();
    const [isMounted, setIsMounted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoorTransition.useEffect": ()=>{
            setIsMounted(true);
        }
    }["DoorTransition.useEffect"], []);
    if (!isMounted) {
...
_s(DoorTransition, "Swn7FIVqx2NqSuZaPTHG1XVSj/g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useRoomStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoomStore"]
    ];
});
_c = DoorTransition;
var _c;
__turbopack_context__.k.register(_c, "DoorTransition");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/animation/TransitionLink.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDoorTransition$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useDoorTransition.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
function TransitionLink({ href, children, className = "", onClick }) {
    _s();
    const { transitionTo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDoorTransition$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDoorTransition"])();
    const handleClick = (e)=>{
        e.preventDefault();
        if (onClick) onClick();
        transitionTo(href);
...
_s(TransitionLink, "OZ4YH32zzlSDETh9LfkgnuopCqQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDoorTransition$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDoorTransition"]
    ];
});
_c = TransitionLink;
var _c;
...
"[project]/components/audio/SoundControl.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SoundControl() {
    _s();
    const { isMuted, setIsMuted, activeSounds } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useRoomStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoomStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SoundControl.useEffect": ()=>{
            // Sync the background ambient drone and chimes based on isMuted
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"]) return;
            if (!isMuted) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].startDrone();
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].startChimes();
                // Also start any custom room sounds if they were toggled
                if (activeSounds.includes("rain")) __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].startRain();
                if (activeSounds.includes("fire")) __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].startFire();
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].stopDrone();
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].stopChimes();
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].stopRain();
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].stopFire();
            }
        }
    }["SoundControl.useEffect"], [
        isMuted,
...
_s(SoundControl, "M3801WZl21mkMK1tLzEgIDs4LVE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useRoomStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoomStore"]
    ];
});
...
"[project]/components/audio/SoundProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const SoundContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
function SoundProvider({ children }) {
    _s();
    const { isMuted, setIsMuted, activeSounds, toggleSound } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useRoomStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoomStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SoundProvider.useEffect": ()=>{
            ...
            if (!isMuted) {
                ...
                if (activeSounds.includes("rain") || activeSounds.includes("synth-rain")) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].startRain();
                } else {
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].stopRain();
                }
                if (activeSounds.includes("fire") || activeSounds.includes("synth-fire")) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].startFire();
                } else {
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].stopFire();
                }
            } else {
    ...
    const playChime = (pitch)=>{
        if (!isMuted && __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"]) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].playChimeNode(pitch);
        }
    };
    const playDoorOpen = ()=>{
        if (!isMuted && __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"]) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audioEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioEngine"].playDoorOpen();
        }
    };
...
_s(SoundProvider, "yocR/ak/QON3dmOhnMBYWiyK6Ug=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useRoomStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoomStore"]
    ];
});
...
function useSoundContext() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(SoundContext);
    if (!ctx) {
        throw new Error("useSoundContext must be used within a SoundProvider");
    }
    return ctx;
}
_s1(useSoundContext, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$animation$2f$TransitionLink$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/animation/TransitionLink.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$audio$2f$SoundControl$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/audio/SoundControl.tsx [app-client] (ecmascript)");
"use client";
;
;
;
function Navbar() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$audio$2f$SoundControl$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/components/layout/Navbar.tsx",
                lineNumber: 22,
                columnNumber: 7
            }, this)
...
"[project]/components/layout/PageTransition.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(PageTransition, "uVDyDwBBj4u1F0tOvvbAkHt8CH8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useRoomStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoomStore"]
    ];
});
...
"[project]/hooks/useDoorTransition.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useDoorTransition() {
    ...
    const { setDoorTransition } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useRoomStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoomStore"])();
    const { playDoorOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSound$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSound"])();
...
_s(useDoorTransition, "CipBTjnp3L4ZHsDo8HZmCx1dLok=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$audio$2f$SoundProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/audio/SoundProvider.tsx [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
function useSound() {
    _s();
    const { isMuted, activeSounds, toggleMute, toggleSoundChannel, playChime, playDoorOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$audio$2f$SoundProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSoundContext"])();
    return {
        isMuted,
        activeSounds,
        toggleMute,
...
_s(useSound, "w6LAYjtwkhd1NqgCwUwaacAz6sY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$audio$2f$SoundProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSoundContext"]
    ];
});
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
const audioEngine = ("TURBOPACK compile-time truthy", 1) ? new AudioEngine() : "TURBOPACK unreachable";
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/store/useRoomStore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_0moghyl._.js.map